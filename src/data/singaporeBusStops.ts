...
export const POPULAR_BUS_SERVICES: Record<string, string[]> = {
  ...
  '04121': ['7', '14', '16', '36', '77', '106', '111', '124', '131', '147', '162', '166', '167', '174', '175', '190', '857'],
...
export const SINGAPORE_BUS_ROUTES: BusRoute[] = [
  ...
  {
    serviceNo: '36',
    name: 'Changi Airport ⟲ Orchard Rd',
    direction: 1,
    origin: 'Changi Airport PTB2',
    destination: 'Orchard Rd (Loop)',
    stops: ['83139', '95029', '95109', '92049', '02111', '08057', '09048', '09059', '01012', '83139'],
    color: '#8B5CF6',
  },
  {
    serviceNo: '24',
  ...
  },
  {
    ...
    stops: ['84009', '82009', '81119', '01112', '08057', '09048', '09059', '18141', '17009'],
    color: '#F97316',
  },
  {
    serviceNo: '14',
    name: 'Bedok ⇄ Clementi (via Marine Parade)',
    direction: 1,
    origin: 'Bedok Interchange',
    destination: 'Clementi Interchange',
    stops: ['84009', '92049', '92119', '01039', '08057', '09048', '11009', '17009'],
    color: '#E11D48',
  },
  {
    serviceNo: '51',
